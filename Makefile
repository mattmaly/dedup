test: build/dedup-tests-main.o build/test-cases/file-test.o build/test-cases/possible-error-test.o build/test-cases/regular-file-test.o
...
build/test-cases/%.o: testing/test-cases/%.cc
	...
	g++ -c -Wall -std=c++20 -I./src/ -I./testing/ $< -o $@
